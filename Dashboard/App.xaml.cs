...
namespace Dashboard
{
	...
	public partial class App : Application
	{
		...
		private void Application_Startup(object sender, StartupEventArgs e)
		{
			...
			//Data.LoadSummaries().Completed += (x, y) =>
			//{
				//Data.CurrentSummary = Data.Summaries.First();
		...
		{
			Dashboard.Controls.BusyIndicator busyIndicator = new Dashboard.Controls.BusyIndicator();
